...
description: Compound Engineering workflow: Plan, Work, Review, Compound. Use when planning features, executing work, reviewing code, or codifying learnings for future iterations.
---

# Compound Engineering Workflow

A development methodology where each unit of work makes subsequent work easier, not harder. Use this approach when planning features, executing work, reviewing code, or codifying learnings in Cursor IDE.
